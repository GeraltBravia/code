     ...
     try
     {
         using (SqlConnection connect = new SqlConnection(conn))
         {
             ...
             using (SqlCommand cID = new SqlCommand(checkID, connect))
             {
                 ...
                 {
                     string insertData = "INSERT INTO movies(movie_id, movie_name, genre, price, movie_image, status, created_at) " +
                                         "VALUES(@movieID, @movieName, @genre, @price, @movieImage, @status, @date)";
